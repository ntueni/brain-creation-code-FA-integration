## Brain creation code - FA integration ##
This is an exension of the brain creation code.
In addition to the atrophy code of the 17-region-model branch, this branch allows the processing of FA (fractional anisotropy) values within the meshing process. This mesh can then be used as an Input in the atrophy branch of the EFI_atrophy_and_tumor branch.
